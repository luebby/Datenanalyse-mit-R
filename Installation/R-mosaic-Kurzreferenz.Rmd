...
corrgram() # Korrelationsplot, aus Paket corrgram
```
...
### Verteilungen
Innerhalb der Funktionen müssen ggf. die Parameter, d. h. `mean=`, `sd=`, bzw. `df=` oder `size=`, `prob=` angepasst werden.
```{r, eval=FALSE}
pbinom() # Verteilungsfunktion Binomialverteilung
qbinom() # Quantilsfunktion Binomialverteilung
...
pf() # Verteilungsfunktion F-verteilung
qf() # Quantilsfunktion F-verteilung
```
