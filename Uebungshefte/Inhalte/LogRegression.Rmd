...
library(caret)
(cm <- confusionMatrix(Aktien$Aktienkauf %>% as.factor(), Aktien$predicted %>% as.factor())) 

# mit Hilfe des Pakets SDMTools (keine offizielle Version für R 4.0.0)
# ggf. install.packages("SDMTools") ausführen
# ab R-Version 4.0.0 devtools::install_github("https://github.com/cran/SDMTools")
# hier kann zusätzlich die Option cutpoint =
library(SDMTools)
