...
```{r echo = FALSE}
knitr::include_graphics("../Uebungshefte/Inhalte/images/visualisieren/Visualisieren.pdf")
```
...
```{r echo = FALSE}
knitr::include_graphics("../Uebungshefte/Inhalte/images/visualisieren/anscombe.pdf")
```
