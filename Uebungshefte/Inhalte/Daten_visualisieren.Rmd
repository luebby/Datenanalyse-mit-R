...
```{r}
download.file("https://raw.githubusercontent.com/sebastiansauer/modar/master/datasets/wo_men.csv", "wo_men.csv")
...
ggplot(data = wo_men) + aes(x = shoe_size) + geom_histogram(aes(y = ..density..), alpha = .7) + geom_density(color = "blue")
```
