...
Hier wurde ein zusätzliche Parameter der Funktion `gf_dotplot` übergeben: `binwidth=1/55`. Dieser Parameter wurde wurde verwendet, um die Abbildung schöner zu machen. Welche Optionen es gibt und was diese bedeuten, kann man in R häufig einfach über die Hilfe, hier also `?gf_dotplot`, erfahren.
