# Kapitel `r kap <- kap+1; kap`: Einf. Wahrscheinl., Inferenz
...
```
Hier wären also zufällig `r tally(~simentscheidung)["Positiv"]` der 151 Entscheidungen des Typ A Positiv gewesen -- wenn es keinen Zusammanhang zwischen Entscheidungstyp und Ratingentscheidung gibt.
...
histogram(~Positiv, data=typAboot, v=79/151) 
```
