...
knitr::include_graphics("../Uebungshefte/Inhalte/images/Datenjudo/Aufbereiten.pdf")
```
...
knitr::include_graphics("../Uebungshefte/Inhalte/images/Datenjudo/filter.pdf")
```
...
knitr::include_graphics("../Uebungshefte/Inhalte/images/Datenjudo/select.pdf")
```
...
knitr::include_graphics("../Uebungshefte/Inhalte/images/Datenjudo/arrange.pdf")
```
...
knitr::include_graphics("../Uebungshefte/Inhalte/images/Datenjudo/group_by.pdf")
```
...
knitr::include_graphics("../Uebungshefte/Inhalte/images/Datenjudo/summarise.pdf")
```
...
```{r cecie-une-pipe, echo = FALSE, fig.align = "center", fig.cap = "La trahison des images [Ceci n'est pas une pipe], René Magritte, 1929, © C. Herscovici, Brussels / Artists Rights Society (ARS), New York, http://collections.lacma.org/node/239578 "}
knitr::include_graphics("../Uebungshefte/Inhalte/images/Datenjudo/ma-150089-WEB.pdf")
```
...
knitr::include_graphics("../Uebungshefte/Inhalte/images/Datenjudo/durchpfeifen.pdf")
```
