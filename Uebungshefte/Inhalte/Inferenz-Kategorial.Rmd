...
pdiff.null <- do(10000) * diffprop( ~ response | shuffle(year), data = de)
# Histogramm
gf_histogram(~ diffprop, data = pdiff.null) %>% gf_vline(xintercept = c(pdiff, -pdiff))
# p-Wert
