...
```
dass bei `r sum(tips$sex=="Female" & tips$smoker=="Yes")` Tischgesellschaften bei denen geraucht wurde eine Frau die Rechnung bezahlte. Im Verhältnis zu allen Tischgesellschaften, bei denen eine Frau zahlte liegt der Raucheranteil also bei `r sum(tips$sex=="Female" & tips$smoker=="Yes") /sum(tips$sex=="Female")`:
```{r eval=FALSE}
