...
Der p-Wert ist klein und das Ergebnis damit *statistisch signifikant*. Die Wahrscheinlichkeit *zufällig* eine solche Differenz der Anteilswerte zu beobachten also gering (wenn die H0 gilt), d. h. es wird auf eine Änderung des Anteilswertes in der *Population* geschlossen.
