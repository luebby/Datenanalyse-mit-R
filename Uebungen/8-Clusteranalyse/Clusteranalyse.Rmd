...
*Hinweis:* Die (robuste) Funktion `pam()` aus dem Paket `cluster` kann auch mit allgemeinen Distanzen umgehen.
...
Einen Biplot des Ergebnisses kann über die Funktion `clusplot()` aus dem Paket `cluster` erhalten.
```{r}
