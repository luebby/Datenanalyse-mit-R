...
Sofern noch nicht geschehen, können Sie z.B. [hier](https://goo.gl/whKjnl) als `csv`-Datei direkt nach R herunterladen:
```{r }
...
Über die Option `v=` werden vertikale Linien an den entsprechenden Stellen gezeichnet.
