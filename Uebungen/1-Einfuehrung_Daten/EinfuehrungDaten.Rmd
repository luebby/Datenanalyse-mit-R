...
Sofern noch nicht geschehen, können Sie in [hier](https://goo.gl/whKjnl) als `csv`-Datei direkt aus R heraus herunterladen:
```{r eval=FALSE}
...
***
**Übung:** Bestimmen Sie das Maximum der Trinkgeldhöhe je Wochentag (`day`)
