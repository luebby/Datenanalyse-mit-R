...
```
erzeugen wir uns einen Vektor, der die 79 positive und 151-79 nicht positiven Urteile von Typ A (alleinige Entscheidung) enthält.
```{r}
tally(~ typA)
```
...
5.  Die Rendite von Google am 26.05.2015 betrug -1.33. Wie hoch ist der z-Wert und interpretieren Sie die Aussage des Ergebnisses.
...
6.  Sie wollen Ihre Google-Aktien absichern. Wie groß ist der Tagesverlust mindestens bei einer maximalen Eintretenswahrscheinlichkeit von 1%?
...
- Andreas Quatember (2010): *Statistik ohne Angst vor Formeln*, Kapitel 2, 3.1-3.3
