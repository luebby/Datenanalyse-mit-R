...
Noch schöner lassen sich drei Dimensionen in einem dreidimensionalen Raum darstellen.
```{r}
library(scatterplot3d)

attach(brand.fa.mean)
scatterplot3d(Leader~Value+Latest)

########## Hier wäre ein einfache Argument für die Positionsbeschriftung mit den Marken interessant !!!!!##########
